...
def plot_resnet_xai(input_data, partitions, shap_values, categories, image_id, save_path: Path, save_fig=False, destroy_fig=False):
    ...
    axes[1].axis("off")
    axes[1].set_title("ResNet-50 Top Classes")
...
def parse_args():
    ...
    parser.add_argument("--results-name", default="resnet_xai_results", help="Results folder created inside output dir/folder.")
